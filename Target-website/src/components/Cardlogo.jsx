      ...
      <div className="parent">
        <div className="card">
          <div className="logo">
            ...
            <span className="text">  <img src="/logo_target-.svg" alt=""
             style={{ width: "120%", height: "120%"}} /></span>
              
            </span>
          </div>
          <div className="glass" />
          <div className="content">
            <span className="text">  <img src="https://res.cloudinary.com/dlup3gczf/image/upload/v1739466523/iivffhbd8lvq85box2nd.jpg" alt=""
             style={{ width: "120%", height: "120%" , scale:"1.1"}} /></span>
          </div>
